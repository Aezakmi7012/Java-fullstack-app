...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse verifyPayment(PaymentVerificationRequest request) {
       ...
       // Set mock payment details
       paymentDetails.setRazorpayOrderId(request.getRazorpayOrderId() != null ? 
           request.getRazorpayOrderId() : "mock_order_" + System.currentTimeMillis());
       paymentDetails.setRazorpayPaymentId(request.getRazorpayPaymentId() != null ? 
           request.getRazorpayPaymentId() : "mock_payment_" + System.currentTimeMillis());
       paymentDetails.setRazorpaySignature(request.getRazorpaySignature() != null ? 
           request.getRazorpaySignature() : "mock_signature_" + System.currentTimeMillis());
